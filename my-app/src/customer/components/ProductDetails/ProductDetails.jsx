    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section>
          ...
          <div className="border p-5 flex flex-row justify-between">
            {/* Left column - Reviews */}
            ...
            <div className="w-5/12">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="opacity-60">59490 Ratings</p>
              </div>

              {/* Box section moved inside the right column */}
              ...
              <Box className="mt-5 space-y-3">
                <Grid container alignItems="center" gap={2}>
                  ...
                  <Grid item xs={7}>
                    <LinearProgress
                      sx={{
                        bgcolor: "#d0d0d0", // background color of the progress bar container
                        borderRadius: 4,
                        height: 7,
                        "& .MuiLinearProgress-bar": {
                          backgroundColor: "#FFEB3B", // light yellow for the progress bar itself
                        },
                      }}
                      variant="determinate"
                      value={25}
        ...
        <section className="pt-10">
          <h1 className="py-5 text-xl font-semibold text-left ">Similar Products</h1>
